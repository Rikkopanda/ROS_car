...
static const _SerialLog_type_support_symbol_names_t _SerialLog_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serial_motor_msgs, msg, SerialLog)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serial_motor_msgs, msg, SerialLog)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serial_motor_msgs, msg, SerialLog)() {
  return &::serial_motor_msgs::msg::rosidl_typesupport_c::SerialLog_message_type_support_handle;
}
